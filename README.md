...
|---|---|---|---|---|---|
| **1.20.1** | `main` | `v2` / `v3.1.0` | KeranAntiCheat 3.1.0 | KeranClient 2.0.0 | ✅ **持续更新中** |
...
本版为独立代码审计后的结构性修复批次，修复 8 项问题（KAC-01 ~ KAC-10），重点解决两类缺陷：一是检测器在结构上无法触发，二是处罚链路形同虚设。详见 [CHANGELOG-3.1.0.md](CHANGELOG-3.1.0.md)。
