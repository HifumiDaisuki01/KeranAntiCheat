...
public enum CheckType {
    ...
    NOSLOW("noslow", "无减速", "使用物品时未减速/进食加速"),
    STEP("step", "爬台阶", "异常台阶攀爬高度"),
    GROUNDSPOOF("groundspoof", "落地伪装", "伪造 onGround 状态"),
    ...
    ANTIKB("antikb", "抗退", "击退抵抗/无击退"),
    HITBOX("hitbox", "命中箱", "命中箱膨胀"),
    BACKTRACK("backtrack", "回溯攻击", "攻击历史位置实体"),
    AUTOBLOCK("autoblock", "自动格挡", "攻击同时格挡"),
    ...
    FASTBREAK("fastbreak", "速挖", "超出工具能力的破坏速度"),
    CHAT("chat", "刷屏", "聊天刷屏"),
    INVENTORY("inventory", "背包操作", "异常背包/自动换装");
