...
public final class MoveUtil {
    ...
    public static boolean isStoneLike(Material m) {
        ...
        String n = m.name();
        // 全部使用精确匹配(equals), 不用 contains。
        // 原因: contains 会让 REDSTONE_ORE 之类含有 STONE 子串的方块被误判成"石头类填充物",
        // 进而污染 XRayCheck 的 oresWithoutStone / ratio 统计。
        // 如未来加入新的石头类方块(如 TUFFSTONE), 在此显式补充而非放宽为 contains。
        return n.equals("STONE") || n.equals("DEEPSLATE") || n.equals("COBBLESTONE")
                || n.equals("COBBLED_DEEPSLATE")
                || n.equals("TUFF") || n.equals("NETHERRACK") || n.equals("END_STONE")
                || n.equals("ANDESITE") || n.equals("DIORITE") || n.equals("GRANITE")
                || n.equals("POLISHED_ANDESITE") || n.equals("POLISHED_DIORITE")
                || n.equals("POLISHED_GRANITE")
                || n.equals("SANDSTONE") || n.equals("RED_SANDSTONE")
                || n.equals("DIRT") || n.equals("GRAVEL") || n.equals("SAND")
                || n.equals("BASALT") || n.equals("SMOOTH_BASALT") || n.equals("CALCITE")
                || n.equals("BLACKSTONE") || n.equals("BASALT_DELTA");
    }
}
